...
def reconocimiento_facial(request):
    if request.method == 'POST':
        # Recibir la imagen en base64 desde el frontend
        ...
        # Convertir los datos a una imagen OpenCV
    ...
    for (x, y, w, h) in faces:
        ...
        roi_gray_resized = cv2.resize(roi_gray, (ancho, alto))  # Ajusta 'ancho' y 'alto'
        ...
        recognized_user = "Nombre del Usuario"  # Cambia esto por el nombre del usuario reconocido
