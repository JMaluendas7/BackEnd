...
def rptoHistoricoFuec(request):
    try:
        if request.method == "POST":
            ...
            cursor.execute("{CALL Sp_RptHistoFuec (?, ?, ?)}",
    ...
    if request.method == 'POST':
        ...
        if request.body:
            ...
            plantilla_path = os.path.join(
                script_dir, '../docs/Plantillas/Plantilla_Rpto_InformeFuec.xlsx')
